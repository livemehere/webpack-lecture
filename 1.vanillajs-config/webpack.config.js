...
module.exports = {
    ...
    module:{
        rules:[
            ...
            {
                test: /\.css$/,
                use: [MiniCssExtractPlugin.loader,'css-loader'] // (js 에서 import 한 css 도 별도의 파일로 추출됨)
            },
            {
    ...
    devServer: {
        ...
        hot: false, // 핫 리로딩이 htmlWebpackPlugin 과 호환이 안되서, 수동 새로고침해야하는 수고가 있기 때문에, 그냥 바닐라 프로젝트라면 안하는 것을 추천(또 SPA 가 아니라면 핫 리로드가 되야할 큰 의미도 없음)
    },
